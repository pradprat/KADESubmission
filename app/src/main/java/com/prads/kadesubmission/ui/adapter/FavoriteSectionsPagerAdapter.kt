...
import com.prads.kadesubmission.ui.FavoriteEventFragment
import com.prads.kadesubmission.ui.FavoriteTeamFragment

private val TAB_TITLES = arrayOf(
    R.string.tab_favorite_1,
    R.string.tab_favorite_2
)
...
class FavoriteSectionsPagerAdapter(
    ...
    override fun getItem(position: Int): Fragment {
        ...
        return when (position) {
            0 -> {
                FavoriteEventFragment.newInstance()
            }
            else -> {
